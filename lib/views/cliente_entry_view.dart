  ...
  Widget build(BuildContext context) {
    ...
    return EventlyScaffold(
      body: EventlyAuthLayout(
        title: 'Aproveite cada\nmomento.',
        description: 'Sua carteira, seus créditos e suas compras. Tudo pronto para você curtir o evento.',
        child: SafeArea(
          child: Center(
